      ...
      >
        ...
        >
          <CyclingTypewriterEffect
            texts={[
              "Pioneer in Multi-Agent Systems & Agentic AI",
              "Full Stack Engineer with 2.5+ years of experience",
              "Expert in AI-powered platforms and scalable backend systems",
              "AWS Certified Solutions Architect - Associate",
              "Specialized in Python, Node.js, and AWS Cloud Services",
              "Building the future with GenAI and automation"
            ]}
        ...
        >
          ...
          <motion.a
            href="/resume/FaisalShaikh_Resume.pdf"
            download="FaisalShaikh_Resume.pdf"
