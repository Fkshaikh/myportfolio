...
export default function ContactSection() {
  ...
  const contactItems = [
    {
      label: 'Email',
      value: 'shaikhfaisal54@gmail.com',
      icon: <IconMail size={24} />,
      link: 'mailto:shaikhfaisal54@gmail.com',
      color: '#c5f9d7',
    },
    {
      label: 'Phone',
      value: '+91 84018 74421',
      icon: <IconPhone size={24} />,
      link: 'tel:+918401874421',
      color: '#f7d486',
    },
    {
      label: 'Location',
          ...
          <div className="space-y-6">
            ...
            >
              <blockquote className="text-white/60 italic text-base font-light">
                "Let's build something that lasts longer than pixels."
              </blockquote>
