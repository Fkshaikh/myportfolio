  ...
  const experiences = [
    {
      ...
      organization: 'ICT, GLS University',
      ...
      technologies: ['C', 'C++', 'Java', 'Python', 'MySQL', 'HTML', 'CSS', 'JavaScript'],
    },
    {
      id: 2,
      type: 'education',
      ...
      color: '#f7d486',
      highlights: [
        'Advanced concepts in software development and system design',
        'Specialized in web technologies and database management',
        'Research work on Machine Learning and Data Science',
        'Published research paper on ML dataset generation'
      ],
      technologies: ['React', 'Node.js', 'Python', 'Machine Learning', 'Data Science', 'PostgreSQL'],
    },
    {
      id: 3,
      type: 'work',
      ...
      highlights: [
        ...
        'Implemented secure payment processing with 25% increase in transaction success rate',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Reduced debugging effort by 80% through innovative automation strategies',
        'Mentoring junior developers and establishing best practices for the team'
      ],
      technologies: ['Python', 'AWS Bedrock', 'Lambda', 'Node.js', 'React', 'AI/ML'],
    },
  ];
        ...
        >
          <div className="flex items-center gap-8">
            <motion.div className="text-center" whileHover={{ scale: 1.1 }}>
              <div className="text-3xl font-bold text-[#c5f9d7]">2018</div>
