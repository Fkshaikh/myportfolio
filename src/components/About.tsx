...
export default function AboutSection() {
  ...
  const skills = [
    ...
    { name: 'AWS', color: '#FF9900', level: 90 },
    { name: 'GenAI', color: '#c5f9d7', level: 85 },
  ];

  const experiences = [
    { year: '2022', event: 'Started Full Stack Journey', icon: '🚀' },
    { year: '2023', event: 'Built 8+ Production Apps', icon: '💼' },
    { year: '2024', event: 'Leading Tech Teams', icon: '👥' },
    { year: 'Now', event: 'Creating Digital Magic', icon: '✨' },
  ];
              ...
              <div className="relative bg-black/90 backdrop-blur-xl rounded-3xl p-6 sm:p-8 m-1">
                ...
                <div className="space-y-4 mb-6">
                  <p className="text-white/80 text-center leading-relaxed text-sm sm:text-base">
                    Full Stack Engineer with 2.5+ years of experience in designing and deploying AI-powered platforms, scalable backend systems, and fullstack web applications.
                  </p>
                  <p className="text-white/70 text-center leading-relaxed text-sm">
                    <span className="text-[#c5f9d7] font-semibold">Pioneer in Multi-Agent Systems & Agentic AI</span> - Creating autonomous solutions that revolutionize business processes.
                  </p>
                  <p className="text-white/70 text-center leading-relaxed text-sm">
                    Currently seeking fully remote opportunity focused on backend or fullstack engineering with AI-driven products.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <motion.a
                    href="mailto:shaikhfaisal54@gmail.com"
                  ...
                  >
                    ...
                    />
                    <span className="text-sm">shaikhfaisal54@gmail.com</span>
                  </motion.a>
                  <motion.div
                  ...
                  {[
                    {
                      ...
                      href: 'https://github.com/Fkshaikh',
                      color: '#ffffff',
                    },
                    {
                      icon: IconBrandLinkedin,
                      href: 'https://www.linkedin.com/in/faisalshaikh54/',
                      color: '#0077b5',
                    },
          ...
          >
            ...
            >
              ...
              <blockquote className="text-white/80 text-sm sm:text-base leading-relaxed italic">
                "I believe in leveraging <span className="text-[#c5f9d7] font-semibold">Multi-Agent Systems and GenAI</span> to solve critical business problems using AWS, Node.js, Python, and React. Every autonomous solution should be scalable, intelligent, and future-ready."
              </blockquote>
              <footer className="mt-4 text-[#c5f9d7] text-sm">
                — Faisal Shaikh, AWS Certified Solutions Architect & GenAI Pioneer
              </footer>
            </motion.div>
          </motion.div>
        </div>
